...
public class ConexionMySQL {
 private boolean status = false;
    ...
    private String nomeDoBanco = "ventas";
    private String usuario = "root";
    private String senha = "manuel2502";
    
    public ConexionMySQL(){}
    
    public ConexionMySQL(String pServidor, String pNomeDoBanco, String pUsuario, String pSenha){
    ...
    //DE AQUI PARA ABAJO TOOOODO DEBES REVISARLO BIEWN...!
    /**
